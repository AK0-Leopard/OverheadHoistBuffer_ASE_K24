    ...
    public class MTLValueDefMapActionNewPH2 : MTxValueDefMapActionBase
    {
            ...
            try
            {
                ...
                if (hand_shake == 1)
                {
                    ...
                    else
                    {
                        ...
                        var car_out_check_result = scApp.MTLService.checkVhAndMTxCarOutStatus(this.MTL, pre_car_out_vh);
        ...
        public override void MTL_CarInRequest(object sender, ValueChangedEventArgs args)
        {
            ...
            try
            {
                ...
                {
                    var check_result = scApp.MTLService.checkVhAndMTxCarInStatus(MTL, pre_car_in_vh);
