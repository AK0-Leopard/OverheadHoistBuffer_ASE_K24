...
namespace com.mirle.ibg3k0.sc.Data.ValueDefMapAction
{
    public class ASEMCSDefaultMapAction : IBSEMDriver, IValueDefMapAction
    {
                    ...
                    case "TRANSFER":
                        ...
                        using (var tx = SCUtility.getTransactionScope())
                        {
                            using (var con = DBConnection_EF.GetUContext())
                            {
                                ...
                                {
                                    scApp.SysExcuteQualityBLL.creatSysExcuteQuality(cmdID, cstID, source, dest);//取消對於SystemQuality的紀錄
                                }
        ...
        public override bool S6F11SendTransferCancelCompleted(string cmd_id, CassetteData cassette, List<AMCSREPORTQUEUE> reportQueues = null)
        {
            try
            {
                VIDCollection Vids = new VIDCollection();
