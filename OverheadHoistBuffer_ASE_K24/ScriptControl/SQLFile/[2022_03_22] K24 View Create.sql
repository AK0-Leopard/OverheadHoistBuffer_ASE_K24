--記得先刪除PK，修改後再重建PK
--原有資料需轉換為Datetime資料匯入

alter table alarm
alter column RPT_DATE_TIME datetime2(7) not null;

alter table alarm
alter column END_TIME datetime2(7)  null;
...
create INDEX IHCMD_OHTC ON HCMD_OHTC(CMD_ID_MCS,VH_ID,CMD_STAUS,CMD_TPYE);
