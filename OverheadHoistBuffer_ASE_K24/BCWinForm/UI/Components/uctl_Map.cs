...
namespace com.mirle.ibg3k0.bc.winform.UI.Components
{
    public partial class uctl_Map : UserControl
    {
        ...
        private void initialMapSpace()
        {
            ...
            else if (BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_Hsinchu_2F) ||
                     BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_ASE_K24))
            {
                space_Height_m = 10000;
                space_Width_m = 50000;
                zoon_Factor = 70;
                defaultMaxScale = 10;
                trackBar_scale.SmallChange = 2;
